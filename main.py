...
uid=4375807178,password=A128C245793F4B7219EF312168DC3158A3F2482A85D03F0B40FA7AFCB4DB040E

# OR Format 2: Line-separated
# uid: 4375807178
# password: A128C245793F4B7219EF312168DC3158A3F2482A85D03F0B40FA7AFCB4DB040E
...
async def Room_Spam(Uid, Rm, Nm, K, V):
    ...
    fields = {
        ...
        2: {
            1: int(Rm),  
            2: "iG:[C][B][FF0000] —͞Nirob×Nirob×Tosenᅠ",  
            3: {
                2: 1,
                3: 1
            },
...
🎯 Target: {target_uid}
🤖 Bot Name: —͞Nirob×Nirob×Tosenᅠ
✅ Status: Ready to join

📱 Player will see:
"—͞Nirob×Nirob×Tosenᅠ wants to join your team"
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]BOT MADE BY Nirob×Tosen Codex 
"""
        else:
...
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY ㅤNirob×Tosen Codex
"""
        else:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][DA70D6]❀️Dev:[FFFFFF]</> Nirob×Tosen Codex
"""
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]Nirob×Tosen Codex 
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@blk_robot
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
def calculate_age(date_string):
    """
    Calculate age from date string (YYYY-MM-DD format)
    Returns: Age in years, and formatted output message
    """
    try:
        # Parse the date string
        birth_date = datetime.strptime(date_string.strip(), "%Y-%m-%d")
        today = datetime.now()
        ...
        if days < 0:
            # If birthday hasn't happened this year, use last year's date
        ...
        return {
            "success": False,
            "error": "Invalid date format! Use YYYY-MM-DD (e.g., 2000-01-15)"
        }
    except Exception as e:
        return {
            "success": False,
...
def format_age_result(age_data):
    """Format the age calculation result into a nice message"""
    if not age_data["success"]:
        return f"[B][C][FF0000]❌ {age_data['error']}\n\n[FFFFFF]📝 Example: /age 2000-01-15"
    
    return f"""[B][C][FFFF00]📅 AGE CALCULATOR

[FFD700]━━━━━━━━━━━━━━━━━━━━━━

[FFFFFF]📆 Birth Date: [00FF00]{age_data['birth_date']}
[FFFFFF]🎂 Current Age: [00FF00]{age_data['age']} years, {age_data['months']} months, {age_data['days']} days

[FFFFFF]📊 Statistics:
[FFFFFF]├ Total Days Lived: [00FF00]{age_data['days_lived']:,} days
[FFFFFF]└ Days Until Birthday: [00FF00]{age_data['days_until_birthday']} days

[FFFFFF]🎉 Next Birthday: [00FF00]{age_data['next_birthday']}

[FFD700]━━━━━━━━━━━━━━━━━━━━━━
[FF00FF]✨ Developed by Nirob×Tosen Codex ✨"""
...
[C][B][FFFF00]│[FF0000]▶[00FFFF]│[00FFFF]║[FFFFFF] Nirob×Tosen Codex TCP BOT[FFFF00]║
...
[b][c][00FF00]Wʟᴄ Tᴏ Nirob×Tosen Codex Bᴏᴛ Hᴇʀᴇ 
❀️ [B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[FFFFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]ㅤ@blk_robot BOT[00FFFF]║
[C][B][00FFFF]╰[00FFFF]─[00FFFF]╯[00FFFF]╚═══════╝
[00FFFF]━━━━━━━━━━━━[FF69B4]"""
                        # In your auto-join (Old Handler) code, find this line:
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by Nirob×Tosen
/bio Level 66 | Pro Player
/bio Add me: Nirob×Tosen
...
║ ────────────── 
║                                       
║ ⚡ [FF00FF]—͟͞͞Ƭ໐፝֟፝sen Cᴏᴅᴇx VIP BOT ⚡   
╚═════════════╝"""
...
[4DA6FF]│
[FFFFFF]├ Owner : [FFFF00]﷽ㅤ—͟͞͞Ƭ໐፝֟፝senㅤ!!
[FFFFFF]└ TG : [00FF00]@blk_robot
...
FF0000]└ [00FF00]/age [FFFFFF][Yar-month-date][example:2005-12-12
[FFFF00]━━━━━━━━━━━━━━━━━"""
...
[FFFF00]━━━━━━━━━━━━━━━━━"""
                            ...
                            whitelist_cmnd = """الْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ (2) الرَّحْمَٰنِ الرَّحِيمِ (3) مَالِكِ يَوْمِ الدِّينِ (4) إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ (5) اهْدِنَا الصِّرَاطَ الْمُسْتَقِيمَ (6) صِرَاطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلَا الضَّالِّينَ (7)"""
...
[FFFF00]━━━━━━━━━━━━"""
                        ...
                        if inPuTMsG.strip().startswith('/age'):
                            print('Processing age calculator command')
    
                            parts = inPuTMsG.strip().split()
    
                            if len(parts) < 2:
                                error_msg = f"""[B][C][FF0000]❌ AGE CALCULATOR USAGE

[FFFFFF]📝 Command: /age (YYYY-MM-DD)

[FFFF00]📋 Examples:
[FFFFFF]/age 2000-01-15
[FFFFFF]/age 1995-07-23
[FFFFFF]/age 2010-12-31

[00FF00]✨ Developed by Nirob×Tosen Codex
"""
                                await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                            else:
                                date_string = parts[1]
                                ...
                                calc_msg = f"[B][C][FFFF00]⏳ Calculating age from {date_string}...\n"
                                await safe_send_message(response.Data.chat_type, calc_msg, uid, chat_id, key, iv)
        
                                # Calculate age
                                age_result = calculate_age(date_string)
        
                                # Format and send result
                                result_msg = format_age_result(age_result)
                                await safe_send_message(response.Data.chat_type, result_msg, uid, chat_id, key, iv)
        
                                print(f"✅ Age calculated for date: {date_string}")
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4375807178,password=A128C245793F4B7219EF312168DC3158A3F2482A85D03F0B40FA7AFCB4DB040E")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞Nirob×Tosen Codexᅠ BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 —͞Nirob×Tosenᅠ BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 —͞Nirob×Tosenᅠ BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞Nirob×Tosenᅠ BOT - ONLINE")
    print("=" * 50)
    print(f"🔹 UID: {TarGeT}")
